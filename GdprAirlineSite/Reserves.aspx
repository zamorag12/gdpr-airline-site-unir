<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reserves.aspx.cs" Inherits="GdprAirlineSite.Reserves" %>
                ...
                <div class="row v-center">
                    <div runat="server" class="col-xs-12 col-md-7 header-text">
                        ...
                        <% }
                            ...
                            { %>
                        <p>
                            Bienvenid@ <%= User.Identity.Name %>
                            <br />
                        </p>
                        <p>
                            Revisar mis reservas: 
                        <a href="https://gdpr-site-unir.herokuapp.com" class="btn btn-success btn-lg">
                            <span class="glyphicon glyphicon-plane"></span>Revisar 
                        </a>
                        </p>
                        <% } %>
                    </div>
